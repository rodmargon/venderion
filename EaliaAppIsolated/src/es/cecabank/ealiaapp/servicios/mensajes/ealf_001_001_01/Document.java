...
public class Document implements org.apache.axis2.databinding.ADBBean {
	...
	protected es.cecabank.ealiaapp.servicios.mensajes.ealf_001_001_01.EalfDeviceDataV01 localDvcData;

	/**
	 * Auto generated getter method
	 * 
	 * @return 
	 *         es.cecabank.ealiaapp.servicios.mensajes.ealf_001_001_01.EalfDeviceDataV01
	 */
	public es.cecabank.ealiaapp.servicios.mensajes.ealf_001_001_01.EalfDeviceDataV01 getDvcData() {
		return localDvcData;
	}
	 ...
	 *            DvcData
	 */
	public void setDvcData(es.cecabank.ealiaapp.servicios.mensajes.ealf_001_001_01.EalfDeviceDataV01 param) {

		this.localDvcData = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
		...
		if (localDvcData == null) {
			throw new es.cecabank.ealiacomun.control.EaliaException("001", "DvcData cannot be null!!");
		}
		localDvcData.serialize(new javax.xml.namespace.QName( "DvcData"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		elementList.add(new javax.xml.namespace.QName("DvcData"));

		if (localDvcData == null) {
			throw new es.cecabank.ealiacomun.control.EaliaException("001", "DvcData cannot be null!!");
		}
		elementList.add(localDvcData);
...
//							return (Document) es.cecabank.ealiaapp.servicios.wsimpl.dispositivos.wsf_dispositivos_actualizar.ExtensionMapper.getTypeObject(nsUri, type, reader);
//						}
//
//					}
//
//				}
				...
				if (reader.isStartElement() && ("DvcData").equals(reader.getLocalName())) {

					object.setDvcData(es.cecabank.ealiaapp.servicios.mensajes.ealf_001_001_01.EalfDeviceDataV01.Factory.parse(reader));
