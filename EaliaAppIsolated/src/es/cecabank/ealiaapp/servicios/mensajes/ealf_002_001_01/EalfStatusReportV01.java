/**
 * EalfStatusReportV01.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis2 version: 1.6.2  Built on : Apr 17, 2012 (05:34:40 IST)
 */

package es.cecabank.ealiaapp.servicios.mensajes.ealf_002_001_01;
...
/**
 * EalfStatusReportV01 bean class
 */
@SuppressWarnings({ "unused", "serial" })
public class EalfStatusReportV01 implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ealfStatusReportV01 Namespace URI =
	 * urn:ealf_002_001_01:mensajes:servicios:ealiaapp:cecabank:es Namespace
	 * Prefix = ns2
	 */
	...
	/**
	 * field for OrgnlGrpInfAndSts
	 */

	protected es.cecabank.ealiacomun.mensajes.elements.complex.ealiaapp.EalfOriginalGroup1 localOrgnlGrpInfAndSts;
	 ...
	 *         EalfOriginalGroup1
	 */
	public es.cecabank.ealiacomun.mensajes.elements.complex.ealiaapp.EalfOriginalGroup1 getOrgnlGrpInfAndSts() {
		return localOrgnlGrpInfAndSts;
	}
	 ...
	 *            OrgnlGrpInfAndSts
	 */
	public void setOrgnlGrpInfAndSts(es.cecabank.ealiacomun.mensajes.elements.complex.ealiaapp.EalfOriginalGroup1 param) {

		this.localOrgnlGrpInfAndSts = param;
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ealfStatusReportV01", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ealfStatusReportV01", xmlWriter);
			}
		...
		if (localOrgnlGrpInfAndSts == null) {
			throw new es.cecabank.ealiacomun.control.EaliaException("001", "OrgnlGrpInfAndSts cannot be null!!");
		}
		localOrgnlGrpInfAndSts.serialize(new javax.xml.namespace.QName( "OrgnlGrpInfAndSts"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		elementList.add(new javax.xml.namespace.QName( "OrgnlGrpInfAndSts"));

		if (localOrgnlGrpInfAndSts == null) {
			throw new es.cecabank.ealiacomun.control.EaliaException("001", "OrgnlGrpInfAndSts cannot be null!!");
		}
		elementList.add(localOrgnlGrpInfAndSts);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static EalfStatusReportV01 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			EalfStatusReportV01 object = new EalfStatusReportV01();
			...
			try {
				...
				if (reader.isStartElement() && ("OrgnlGrpInfAndSts").equals(reader.getLocalName())) {

					object.setOrgnlGrpInfAndSts(es.cecabank.ealiacomun.mensajes.elements.complex.ealiaapp.EalfOriginalGroup1.Factory.parse(reader));
